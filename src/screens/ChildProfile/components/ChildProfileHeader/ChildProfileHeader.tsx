...
// Subtle pill — always same quiet style, active state just slightly darker border
const DesignPill = () => {
  ...
  return (
    <button
      ...
      className="inline-flex items-center h-[18px] px-1.5 rounded-full text-[10px] font-medium border border-mfneutralsn-200 bg-transparent text-mfneutralsn-300 hover:border-mfneutralsn-300 transition-colors"
    >
      Previous design
    </button>
  );
...
// Shared title bar — used by both new and classic
